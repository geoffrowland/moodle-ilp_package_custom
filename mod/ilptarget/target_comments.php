...
/// Print the main part of the page
	...
	$course = $course = get_record('course', 'id', $courseid);
		...
		print_header("$strtargets: ".fullname($user)."", "", "$navigation -> ".$strtargets." -> ".fullname($user)."", 
...
//		echo '<a href="'.$link_values.'&amp;action=updatecomment">'.get_string('addcomment', 'ilptarget').'</a></div>';
              echo '<a class="button" href="'.$link_values.'&amp;action=updatecomment"" onclick="this.blur();"><span>'.get_string('addcomment', 'ilptarget').'</span></a>';
              echo '</div>';
